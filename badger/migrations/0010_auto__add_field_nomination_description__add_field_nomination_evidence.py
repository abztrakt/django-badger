...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Nomination.description'
        db.add_column('badger_nomination', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Nomination.evidence'
        db.add_column('badger_nomination', 'evidence', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Nomination.description'
        db.delete_column('badger_nomination', 'description')

        # Deleting field 'Nomination.evidence'
        db.delete_column('badger_nomination', 'evidence')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 9, 16, 47, 12, 24732)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 9, 16, 47, 12, 24582)'}),
        ...
        'badger.badge': {
            ...
            'criteria_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        'badger.deferredaward': {
            ...
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['badger.Badge']"}),
            'claim_code': ('django.db.models.fields.CharField', [], {'default': "'xkxkme'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
