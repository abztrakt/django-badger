...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Badge.criteria_url'
        db.add_column('badger_badge', 'criteria_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Badge.criteria_url'
        db.delete_column('badger_badge', 'criteria_url')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 9, 16, 21, 4, 792581)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 9, 16, 21, 4, 792405)'}),
        ...
        'badger.deferredaward': {
            ...
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['badger.Badge']"}),
            'claim_code': ('django.db.models.fields.CharField', [], {'default': "'47acut'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
