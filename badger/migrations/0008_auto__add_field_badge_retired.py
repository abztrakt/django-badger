...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Badge.retired'
        db.add_column('badger_badge', 'retired', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Badge.retired'
        db.delete_column('badger_badge', 'retired')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 7, 11, 15, 31, 481091)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 7, 11, 15, 31, 480943)'}),
        ...
        'badger.badge': {
            ...
            'retired': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'badger.deferredaward': {
            ...
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['badger.Badge']"}),
            'claim_code': ('django.db.models.fields.CharField', [], {'default': "'yymn43'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
